...
1. Transfer Lane 7 Bottleneck (Incident Cluster A)
2. Charger BCSS-02 Trip (Incident Cluster B)

Please investigate both incidents by querying the appropriate MCP telemetry and diagnostic tools:
- Check lane queues, lead vehicles, and AGV actuator telemetry for Lane 7.
- Check BCSS-02 charger status, busbar temperatures, and breaker states.
- Decode any PLC fault codes identified during the sensor inspection.
- Check maintenance history for the affected assets.
